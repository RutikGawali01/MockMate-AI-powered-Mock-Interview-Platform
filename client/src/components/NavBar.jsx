            ...
            {showUserPopUp && (
              <div className="absolute right-0 w-48 mt-3 bg-white border border-gray-200 rounded-lg shadow-xl p-5 z-50">
                ...
                <button
                  ...
                  className="w-full bg-gray-100 text-gray-800 py-2 rounded-lg  text-sm mb-2 hover:bg-gray-200 transition"
                >
                  History
                </button>
                <button
                  onClick={handleLogout}
                  className="w-full bg-red-500 text-white py-2 rounded-lg  text-sm hover:bg-red-600 transition flex items-center justify-center gap-2"
                >
