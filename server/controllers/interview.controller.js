...
export const generateQuestions = async (req, res) => {
  try {
    ...
    if (questionsArray.length === 0) {
      return res
        .status(500)
        .json({ message: "AI did not return valid questions" });
    }
    user.credits -= 50;
    await user.save();
    ...
    res
      .status(500)
      .json({ message: `failed to create interview ${err.message}` });
  }
};
...
export const finishInterview = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: `failed to finish interview ${err.message}` });
  }
};
...
export const getMyInterviews = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: `failed to get interviews ${err.message}` });
  }
};
export const getInterviewReport = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: `failed to get interview report ${err.message}` });
  }
};
